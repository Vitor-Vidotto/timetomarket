...
const RenameDesc: React.FC = () => {
  ...
  async function renameFinal() {
    ...
    try {
      const result = await invoke<string>("rename_desc", {
        directory,
  ...
  return (
    <div className=" items-center justify-center bg-gray-100 p-8">
      <div className="max-w-lg w-full bg-white shadow-xl rounded-lg p-8">
        <h3 className="text-2xl font-semibold text-center text-black mb-6">Remover Descrição</h3>
